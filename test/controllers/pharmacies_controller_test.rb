...
class PharmaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pharmacy" do
    assert_difference("Pharmacy.count") do
      post pharmacies_url, params: { pharmacy: { address: @pharmacy.address, email: @pharmacy.email, name: @pharmacy.name, phone: @pharmacy.phone } }
    end
  ...
  test "should update pharmacy" do
    patch pharmacy_url(@pharmacy), params: { pharmacy: { address: @pharmacy.address, email: @pharmacy.email, name: @pharmacy.name, phone: @pharmacy.phone } }
