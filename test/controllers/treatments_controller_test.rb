...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference("Treatment.count") do
      post treatments_url, params: { treatment: { appointment_id: @treatment.appointment_id, client_id: @treatment.client_id, diagnosis_id: @treatment.diagnosis_id, name: @treatment.name, user_id: @treatment.user_id } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { appointment_id: @treatment.appointment_id, client_id: @treatment.client_id, diagnosis_id: @treatment.diagnosis_id, name: @treatment.name, user_id: @treatment.user_id } }
